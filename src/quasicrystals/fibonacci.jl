...
"""
function generate_fibonacci_projection(n_points::Int; method::ProjectionMethod=ProjectionMethod())
...
- `QuasicrystalData{1,Float64}`: generated Fibonacci lattice data
"""
function generate_fibonacci_substitution(generations::Int; method::SubstitutionMethod=SubstitutionMethod())
    # Start with L
    sequence = ['L']
